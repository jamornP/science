...
$pdf->Cell(60, 0, "สาขา", 1, 0, 'C', 1);
$pdf->Cell(60, 0, "ภาควิชา", 1, 0, 'C', 1);
...
foreach($datas as $value){
    ...
    $pdf->Cell(50, 0, $value['name']." ".$value['name'], 1, 0, 'C', 1);
    $pdf->Cell(30, 0, $value['tel'], 1, 0, 'C', 1);
    $pdf->Cell(60, 0, $value['magor'], 1, 0, 'C', 1);
    $pdf->Cell(60, 0, $value['department'], 1, 0, 'C', 1);
