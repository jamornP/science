...
$json_string = 'https://script.google.com/macros/s/AKfycbzx-s5zMBoDTxOjZLRvEMD7Rs1aG6LN2Y-XabQ5c5AEHaqcb3IT2gR6U4z4-2buhRtn/exec';
$response = file_get_contents($json_string);
$data2 = json_decode($response, true);
?>
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม Physibot วันที่ 11 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
                <thead>
                    <tr>
...
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม Physibot วันที่ 12 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
                <thead>
                    <tr>
