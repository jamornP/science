...
<?php
$json_string = 'https://script.google.com/macros/s/AKfycbxbsA4sznl1ISsvXKZhTQF3NyaBsHIY_A0WssupQwRmbIpS24ZxoLWE0-FTZLHZDjxt/exec';
$response = file_get_contents($json_string);
$data1 = json_decode($response, true);
$json_string = 'https://script.google.com/macros/s/AKfycbx7aFEyM6lV626gATPPxaDa4DvEKDYkLmVELXAeD1SV5ptzCnKOhIJ7sjhAl1Ficv0/exec';
$response = file_get_contents($json_string);
$data2 = json_decode($response, true);
?>
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม DIY เมนูง่ายๆจากสาหร่ายสไปลูริน่า วันที่ 11 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
                <thead>
                    <tr>
...
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม DIY เมนูง่ายๆจากสาหร่ายสไปลูริน่า วันที่ 12 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
            <thead>
                    <tr>
