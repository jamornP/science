...
<?php
$json_string = 'https://script.google.com/macros/s/AKfycbz-5_q6Ojm-RocJsumDGgYXUww4P4U-F3UrfWgCLArXmpe97FpzLLVdMZtV88Z47ogQTA/exec';
$response = file_get_contents($json_string);
$data1 = json_decode($response, true);
$json_string = 'https://script.google.com/macros/s/AKfycbxexGD1NSjUldXtOkFdOZU0VmYs3E6LGPQukhB7g61phR6D9O4jBlgJQt6Qvk6kls-s/exec';
$response = file_get_contents($json_string);
$data2 = json_decode($response, true);
?>
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม นักสืบติดดิน วันที่ 11 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
                <thead>
                    <tr>
...
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม นักสืบติดดิน วันที่ 12 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
            <thead>
                    <tr>
