...
<?php
$json_string = 'https://script.google.com/macros/s/AKfycbyj_KAyygrZl6EW0Vj7ykZliYWDaW8nBxFSQDXiZF-OTinw3zvbZTo1cXJ_Zr57GkrcuA/exec';
$response = file_get_contents($json_string);
$data1 = json_decode($response, true);
$json_string = 'https://script.google.com/macros/s/AKfycbxz3NRMEEXMjrcA_SdFMhyu38MFT5qV67uhOa5B4Nz3dP47guJOyBLS8t4k0mUbPape/exec';
$response = file_get_contents($json_string);
