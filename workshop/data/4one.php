...
<?php
$json_string = 'https://script.google.com/macros/s/AKfycbwf6-7uTJdrsuPOT2mhpSuimPyAH9qn614s7B75qhWMr8OyrbP77QkoiCgBzX43yeOq/exec';
$response = file_get_contents($json_string);
$data1 = json_decode($response, true);
$json_string = 'https://script.google.com/macros/s/AKfycby3fwAQZd8-c9LhguFae8m6UNGLaBijGOOUsFizKsbL6-I6uT5ONJuAoL6ng6dLZecTNw/exec';
$response = file_get_contents($json_string);
$data2 = json_decode($response, true);
?>
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม Data analyst Readiness วันที่ 11 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
                <thead>
                    <tr>
...
<div class="container mt-5">
    <div class="card">
        <h5 class="card-header">รายชื่อกิจกรรม Data analyst Readiness วันที่ 12 พ.ย. 2565</h5>
        <div class="card-body">
            <table class="table">
            <thead>
                    <tr>
