...
<?php 
 ...
 $microObj = new Micro;
 $micros = $microObj->getMicroById($_REQUEST['p_id']);  
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="shadow-lg p-3 mb-5 bg-white rounded mt-3 fs-24">
                    <div class="rounded-pill bg-primary text-white">&nbsp;&nbsp;&nbsp; <?php echo "รูปภาพ "; ?> </div>
                
                    <div class="mt-2">
                        <?php
                        // echo $img;
                        $images = $imageObj->getImageById($img);
                        // print_r($images);
                        // print_r($micros);
