    ...
    <div class="container mt-3">
            ...
            <div class="col-lg-12">
                <div class="shadow-lg p-3 mb-5 bg-white rounded mt-3 fs-20 table-responsive">
                    ...
                    <?php 
                        ...
                        $show = $showroundObj->ShowByActivity(3,1);
                        ...
                        <div class="d-flex flex-row-reverse bd-highlight mt-3">
                            ...
                            <button type='button' class='btn btn-warning' data-bs-toggle='modal' data-bs-target='#edit'>
                                ...
                                <a href="/science/sciday/success.php?project_id=<?php echo $projects['id']; ?>&activity_id=3&user_id=<?php echo $_SESSION['user_id']; ?>" class='btn btn-success text-white'>ยืนยันข้อมูลถูกต้อง</a>&nbsp;
                                <?php
        ...
        <?php 
            ...
            if($show['showround']=='yes'){
                ...
                // print_r($project2s);
                $round2s = $roundObj->checkRound(base64_decode($_REQUEST['iot_id']),2,3,$project2s['level_id']);
                if($round2s){
                    $round2s = $roundObj->getRound($project2s['id'],2,3,$project2s['level_id']);
            ?>
                    <div class="d-flex justify-content-between">
                                ...
                                <table class="table table-striped table-hover mt-2 fs-18">
                                    ...
                                    <tbody class="fs-14">
                                        ...
                                        <?php 
                                            ...
                                            $ck2 = $roundObj->checkRound($project2s['id'],2,3,$project2s['level_id']);
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="video.php" method="post">
                    ...
                    <input type="hidden" class="form-control" id="exampleFormControlInput1" placeholder="" value="3" name="activity_id">
