                    ...
                    <?php 
                        ...
                        if($show['edit_data']=='yes'){
                            ...
                            <div class="d-flex flex-row-reverse bd-highlight mt-3">
                                ...
                                <button type='button' class='btn btn-warning text-white' data-bs-toggle='modal' data-bs-target='#edit'>
                                <i class='bx bx-edit' ></i> แก้ไขข้อมูล
                                </button>&nbsp;
                                <a href="/science/sciday/success.php?project_id=<?php echo $projects['id']; ?>&activity_id=4&user_id=<?php echo $_SESSION['user_id']; ?>" class='btn btn-success text-white'>ยืนยันข้อมูลถูกต้อง</a>&nbsp;
                                <?php
