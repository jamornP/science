...
<body class="font-prompt">
    ...
    <?php
        ...
        CURLOPT_POSTFIELDS =>'{ "studentName": "","certificateName": "นิทรรศการวันวิทยาศาสตร์ Science for every Generation","createDate": "2022-09-11T00:00:00+07:00", "sortBy": "batchId,", "sortDirectionBy": "DESC", "limit": { "pageSize": 1000, "pageNumber": 1 }}',
    ...
    <div class="card">
        <div class="card-header">
            <a href="/science/sciday/certificate/certificate3.php" class="btn btn-success text-white"> Next >></a>
        </div>
        <div class="card-body">
            <table class="table">
                <thead>
        ...
        <div class="mt-4">
            <a href="/science/sciday/certificate/certificate3.php" class="btn btn-success"> Next >></a>
        </div>
    </div>
