...
$data = $artifactObj->getArtifactByLevel($_REQUEST['level_id']);
// print_r($data);
$column_head_arr = ['ลำดับ','ชื่อสิ่งประดิษฐ์','โรงเรียน','นักเรียน','อาจารย์ที่ปรึกษา','เบอร์โทร'];
...
$title = "การประกวดสิ่งประดิษฐ์ทางวิทยาศาสตร์";
...
foreach($data as $value){
   ...
   $sheet->SetCellValue($column_excel_arr[$index].$j,$value['artifact_name']);$index++;
