                                        ...
                                        foreach($chooses as $choose) {
                                            ...
                                            echo "
                                                <tr  valign='middle'>
                                                    ...
                                                    <td>{$choose['name']}</td>
                                                    <td align='right'>
                                                        <a href='form.php?id={$choose['id']}&action=edit' class='me-md-2 btn btn-sm btn-warning text-white'><i class='bx bx-message-square-edit' ></i> แก้ไข</a>
                                                        <a href='save.php?id={$choose['id']}&action=delete' class='btn btn-sm btn-danger text-white'><i class='bx bx-message-square-minus' ></i> ลบ</a>
                                                    </td>
